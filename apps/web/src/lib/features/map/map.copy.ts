...
export const copy = defineCopy({
	en: {
		...
		mapErrorBody: 'The map could not start. Try again.',
		mapRetry: 'Retry map',
		...
		activeTitle: 'Active',
		controlsCollapse: 'Collapse controls',
		controlsExpand: 'Expand controls',
		controlsDone: 'Done',
		rail: {
			motion: 'Pos.',
			markers: 'Mark.',
		...
		motion: {
			...
			smooth: 'Estimated',
			raw: 'Reported',
			toRaw: 'Show reported positions only',
			toSmooth: 'Animate estimated positions between reports',
			hintSmooth: 'Between reports',
			hintRaw: 'Latest reports',
			explain: 'Method',
		},
	},
	fr: {
		...
		mapErrorBody: 'La carte n’a pas pu démarrer. Réessayez.',
		...
		activeTitle: 'Actifs',
		controlsCollapse: 'Réduire les contrôles',
		controlsExpand: 'Développer les contrôles',
		controlsDone: 'Terminé',
		rail: {
			motion: 'Pos.',
			markers: 'Marq.',
			alerts: 'Alertes',
		...
		motion: {
			...
			smooth: 'Estimées',
			raw: 'Signalées',
			toRaw: 'Afficher les positions signalées seulement',
			toSmooth: 'Animer les positions estimées entre les relevés',
			hintSmooth: 'Entre les relevés',
			hintRaw: 'Derniers signalements',
			explain: 'Méthode',
		},
	},
});
