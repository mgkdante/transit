...
export const MAP_SELECTION_DETAIL_COPY = defineCopy({
	en: {
		...
		alertsUnavailable: 'Alert data unavailable',
		...
		selectAlertAction: 'Select alert',
		foreignLanguage: '(French only)',
		alertLink: 'Details',
		alertLinkAria: (host: string) => `Open alert details on ${host} (new tab)`,
		...
		detailStale: 'Showing the last available detail',
	...
	fr: {
		...
		alertsUnavailable: "Données d'alerte indisponibles",
		...
		selectAlertAction: 'Sélectionner l’alerte',
		foreignLanguage: '(en anglais seulement)',
		alertLink: 'Détails',
		alertLinkAria: (host: string) => `Ouvrir les détails de l’alerte sur ${host} (nouvel onglet)`,
		...
		detailStale: 'Dernier détail disponible affiché',
