...
export const copy: Record<Locale, NetworkCopy> = {
	en: {
		...
		trend: {
			onTimeLabel: 'On-time %',
			retardLabel: 'P90 delay (min)',
			summary: 'Daily on-time % and p90 delay over the recent network trend.',
		},
		noData: 'no data',
		units: { pct: '%', min: ' min' },
	},
	fr: {
		...
		trend: {
			...
			retardLabel: 'Retard P90 (min)',
			summary: 'Ponctualité quotidienne et retard p90 sur la tendance récente du réseau.',
		},
