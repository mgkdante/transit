...
{#snippet offenderSevereRateCell(row: OffenderEvidenceRow)}
	<MaybeValue value={row.severeRate} variant="row" reason="no-observations" {locale} />
...
{#snippet offenderAverageDelayCell(row: OffenderEvidenceRow)}
	<MaybeValue value={row.averageDelay} variant="row" reason="no-observations" {locale} />
{/snippet}

{#snippet offenderReadingsCell(row: OffenderEvidenceRow)}
	<MaybeValue value={row.readings} variant="row" reason="no-observations" {locale} />
{/snippet}
