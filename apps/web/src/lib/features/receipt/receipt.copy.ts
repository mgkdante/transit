...
export const copy = defineCopy({
	en: {
		observation: {
			copy: 'Copy this observation',
			copying: 'Copying…',
			copied: 'Observation copied.',
			fallback: 'Clipboard access failed. Select and copy the text below.',
			...
			coverage: 'Published receipt dates (gaps may exist)',
			telemetry: 'Reliability data published',
			schedule: 'Schedule data published',
			yes: 'yes',
			no: 'no',
	...
	fr: {
		observation: {
			copy: 'Copier cette observation',
			copying: 'Copie en cours…',
			copied: 'Observation copiée.',
			fallback: 'Accès au presse-papiers impossible. Sélectionnez et copiez le texte ci-dessous.',
			text: 'Texte de l’observation',
			provider: 'Réseau',
			date: 'Date locale des observations',
			generated: 'Produit (UTC)',
			generation: 'Génération de publication',
			methodology: 'Version de la méthode',
			coverage: 'Dates des reçus publiés (des lacunes sont possibles)',
			telemetry: 'Données de fiabilité publiées',
			schedule: 'Données d’horaire publiées',
			yes: 'oui',
			no: 'non',
			unknown: 'non signalé',
			page: 'Reçu',
