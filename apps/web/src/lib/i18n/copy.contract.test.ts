...
describe('bilingual copy contract', () => {
	...
	test('preserves every localized runtime value, function body, and key order', () => {
		expect(
			...
			navPillCopy: '73a64647e636aae7ee5f0fedb96508a2beaa60e0d4ba24aa14cf5a3cc8442443',
			...
			searchCopy: '95f0cded4a1c1cbad580a147fefd52c9aaafc44823ba330a20caf19c48c0189c',
