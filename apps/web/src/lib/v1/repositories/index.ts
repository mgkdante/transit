...
export const repositories = {
	...
	historic: {
		...
		hotspotsHistoryIndex: getHotspotsHistoryIndex,
		hotspotsHistoryDay: getHotspotsHistoryDay,
		repeatOffenders: getRepeatOffenders,
		repeatOffendersHistoryIndex: getRepeatOffendersHistoryIndex,
		repeatOffendersHistoryDay: getRepeatOffendersHistoryDay,
